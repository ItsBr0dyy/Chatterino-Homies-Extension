(() => {
  ...
  function updateErrors() {
    ...
    if (errors.osUnsupported) {
      errorDiv.innerHTML =
        'The Chatterino Homies Native Host browser extension currently only works on Windows.';
    ...
    if (errors.sendMessage) {
      errorDiv.innerHTML =
        closeButton +
        'Connection to the Chatterino Homies extension lost!<br><br>' +
        'Please reload the page.';
    } else {
      errorDiv.innerHTML =
        closeButton +
        'Chatterino Homies should show here:<br><br>' +
        'Try deselecting and selecting the page.<br>' +
        'Chatterino Homies also needs to be running.<br><br>' +
